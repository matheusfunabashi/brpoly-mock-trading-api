...
function outcomeId(marketId, key) {
...
async function main() {
    ...
    const markets = await prisma.$transaction(async (tx) => {
        ...
        const marketA = await createMarket({
            ...
            description: "Resolve para SIM se Luiz Inácio Lula da Silva vencer a eleição presidencial de 2026.",
            category: "Política",
        ...
        return [marketA, marketB, marketC];
    });
